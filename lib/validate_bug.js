var states = require('./states'),
    resolveAttachment = require('./resolve_attachment');
...
@return {Object|Null} (unix style) null is success an object is a error status.
*/
function validateBug(reviewers, attachments) {
  ...
  // there are attachments but no github attachments
  if (!attachment) {
    return states('NO_GITHUB_ATTACHMENT');
  }
